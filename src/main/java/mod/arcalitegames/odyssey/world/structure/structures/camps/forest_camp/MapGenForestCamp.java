...
public class MapGenForestCamp extends MapGenStructure implements Serializable
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -2958861748975833962L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.FOREST_CAMP.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new ForestCamp(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	ForestCampComponents.generatePart1();
                ForestCampComponents.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	ForestCampComponents.generatePart3();
                ForestCampComponents.generatePart4();
                this.generatePart = 3;
            }
        }
        ...
        public void generatePart3(WorldTickEvent event)
        {
            ...
            {
            	ForestCampComponents.generatePart5();
                ForestCampComponents.generatePart6();
                this.generatePart = 4;
            }
        }
