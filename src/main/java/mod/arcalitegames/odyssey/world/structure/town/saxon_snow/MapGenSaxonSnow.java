...
public class MapGenSaxonSnow extends Structure<NoFeatureConfig>
{
    private static BlockPos origin;

    public MapGenSaxonSnow() {
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return MapGenSaxonSnow.Start::new;
    }
    ...
    public static class StructurePiece
    {
        ...
        public static SaxonSnow structure;

        public static void generate(World world)
        {
            if(origin != null)
            {
                structure = new SaxonSnow(world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        {
            SaxonSnowComponent0.generatePart1();
            SaxonSnowComponent0.generatePart2();
            StructurePiece.generatePart = 2;
        }

        public static void generatePart2()
        {
            SaxonSnowComponent0.generatePart3();
            SaxonSnowComponent0.generatePart4();
            StructurePiece.generatePart = 3;
        }

        public static void generatePart3()
        {
            SaxonSnowComponent0.generatePart5();
            SaxonSnowComponent0.generatePart6();
            StructurePiece.generatePart = 4;
        }

        public static void generatePart4()
        {
            SaxonSnowComponent0.generatePart7();
            SaxonSnowComponent0.generatePart8();
            StructurePiece.generatePart = 5;
        }

        public static void generatePart5()
        {
            SaxonSnowComponent0.generatePart9();
            SaxonSnowComponent0.generatePart10();
            StructurePiece.generatePart = 6;
        }

        public static void generatePart6()
        {
            SaxonSnowComponent1.generatePart11();
            SaxonSnowComponent1.generatePart12();
            StructurePiece.generatePart = 7;
        }

        public static void generatePart7()
        {
        	SaxonSnowComponent1.generatePart13();
        	SaxonSnowComponent1.generatePart14();
            StructurePiece.generatePart = 8;
        }

        public static void generatePart8()
        {
        	SaxonSnowComponent1.generatePart15();
        	SaxonSnowComponent1.generatePart16();
            StructurePiece.generatePart = 9;
        }

        public static void generatePart9()
        {
        	SaxonSnowComponent1.generatePart17();
        	SaxonSnowComponent1.generatePart18();
            StructurePiece.generatePart = 10;
        }

        public static void generatePart10()
        {
        	SaxonSnowComponent1.generatePart19();
        	SaxonSnowComponent1.generatePart20();
            StructurePiece.generatePart = 11;
        }

        public static void generatePart11()
        {
            SaxonSnowComponent2.generatePart21();
            SaxonSnowComponent2.generatePart22();
            StructurePiece.generatePart = 12;
        }

        public static void generatePart12()
        {
            SaxonSnowComponent2.generatePart23();
            SaxonSnowComponent2.generatePart24();
            StructurePiece.generatePart = 13;
        }
        
        public static void generatePart13()
        {
            SaxonSnowComponent2.generatePart25();
            SaxonSnowComponent2.generatePart26();
            SaxonSnowComponent2.generatePart27();
