...
public class StatueWarriorSpearShield extends StructureBase
{

	public StatueWarriorSpearShield(World worldIn, BlockPos origin, int xRange, int yRange, int zRange)
	{
		super(worldIn, origin, xRange, yRange, zRange);
		SpearShieldComponents.init(world, origin, this);
