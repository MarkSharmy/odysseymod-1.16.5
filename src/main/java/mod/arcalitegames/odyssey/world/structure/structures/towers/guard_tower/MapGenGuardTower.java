...
public class MapGenGuardTower extends MapGenStructure implements Serializable
{
	...
	public boolean canGenerate(BlockPos start)
    {
    	...
    	StructureClass structureClass = Structures.GUARD_TOWER.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new GuardTower(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	GuardTowerComponents.generatePart1();
                this.generatePart = 0;
            }
        }
    }
