...
public class MapGenFountainTower extends MapGenStructure implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = -4845010503528087192L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.FOUNTAIN_TOWER.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public FountainTower structure;
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new FountainTower(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	FountainComponents.generatePart1();
            	FountainComponents.generatePart2();
                this.generatePart = 0;
            }
        }
    }
