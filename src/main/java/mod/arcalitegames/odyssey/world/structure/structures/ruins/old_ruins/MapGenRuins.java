...
public class MapGenRuins extends MapGenStructure implements Serializable
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -8513883582404384421L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.RUINS.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new Ruins(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	RuinsComponents.generatePart1();
                RuinsComponents.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	RuinsComponents.generatePart3();
                RuinsComponents.generatePart4();
                this.generatePart = 3;
            }
        }
        ...
        public void generatePart3(WorldTickEvent event)
        {
            ...
            {
            	RuinsComponents.generatePart5();
                RuinsComponents.generatePart6();
                this.generatePart = 4;
            }
        }
        ...
        public void generatePart4(WorldTickEvent event)
        {
            ...
            {
            	RuinsComponents.generatePart7();
                RuinsComponents.generatePart8();
                this.generatePart = 5;
            }
        }
