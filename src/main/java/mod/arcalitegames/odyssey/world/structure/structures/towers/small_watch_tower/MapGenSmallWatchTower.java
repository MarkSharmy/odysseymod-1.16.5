...
public class MapGenSmallWatchTower extends MapGenStructure implements Serializable
{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 188481464167783478L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.SMALL_WATCH_TOWER.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public SmallWatchTower structure;
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new SmallWatchTower(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	SmallTowerComponents.generatePart1();
                this.generatePart = 0;
            }
        }
    }
