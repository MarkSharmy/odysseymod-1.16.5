...
public class MapGenIllagerCamp extends MapGenStructure implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 99394093385669943L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.ILLAGER_CAMP.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new IllagerCamp(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent0.generatePart1();
                IllagerComponent0.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent0.generatePart3();
                IllagerComponent0.generatePart4();
                this.generatePart = 3;
            }
        }
        ...
        public void generatePart3(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent0.generatePart5();
                IllagerComponent0.generatePart6();
                this.generatePart = 4;
            }
        }
        ...
        public void generatePart4(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent0.generatePart7();
                IllagerComponent0.generatePart8();
                this.generatePart = 5;
            }
        }
        ...
        public void generatePart5(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent0.generatePart9();
                IllagerComponent0.generatePart10();
                this.generatePart = 6;
            }
        }
        ...
        public void generatePart6(WorldTickEvent event)
        {
            ...
            {
            	IllagerComponent1.generatePart11();
                IllagerComponent1.generatePart12();
                this.generatePart = 7;
            }
        }
        ...
        public void generatePart7(WorldTickEvent event)
        {
        	...
        	{
        		IllagerComponent1.generatePart13();
            	IllagerComponent1.generatePart14();
                this.generatePart = 0;
        	}
        }
    }
