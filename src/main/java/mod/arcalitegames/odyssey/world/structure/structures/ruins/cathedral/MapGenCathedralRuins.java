...
public class MapGenCathedralRuins extends MapGenStructure implements Serializable
{

	/**
	 * 
	 */
	private static final long serialVersionUID = -6339060588334799751L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.CATHEDRAL_RUINS.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public CathedralRuins structure;
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new CathedralRuins(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	CathedralComponents.generatePart1();
                CathedralComponents.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	CathedralComponents.generatePart3();
                CathedralComponents.generatePart4();
                this.generatePart = 3;
            }
        }
        ...
        public void generatePart3(WorldTickEvent event)
        {
            ...
            {
            	CathedralComponents.generatePart5();
                CathedralComponents.generatePart6();
                this.generatePart = 4;
            }
        }
        ...
        public void generatePart4(WorldTickEvent event)
        {
            ...
            {
            	CathedralComponents.generatePart7();
                this.generatePart = 0;
            }
        }
    }
