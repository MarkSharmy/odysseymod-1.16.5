...
public class MapGenWatchTower extends MapGenStructure implements Serializable
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1555601482044468452L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.WATCH_TOWER.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new WatchTower(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	WatchTowerComponents.generatePart1();
                this.generatePart = 0;
            }
        }
    }
