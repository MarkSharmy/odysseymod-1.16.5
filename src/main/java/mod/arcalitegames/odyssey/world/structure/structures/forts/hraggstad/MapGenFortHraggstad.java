...
public class MapGenFortHraggstad extends MapGenStructure implements Serializable
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 9129292437896217417L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.FORT_HRAGGSTAD.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public FortHraggstad structure;
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new FortHraggstad(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	HraggstadComponents.generatePart1();
                HraggstadComponents.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	HraggstadComponents.generatePart3();
                HraggstadComponents.generatePart4();
                this.generatePart = 3;
            }
        }
        ...
        public void generatePart3(WorldTickEvent event)
        {
            ...
            {
            	HraggstadComponents.generatePart5();
                HraggstadComponents.generatePart6();
                this.generatePart = 0;
            }
        }
