...
public class MapGenDarkTower extends MapGenStructure implements Serializable
{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5736297657011360788L;

	@Override
	public boolean canGenerate(BlockPos start)
    {
    	
    	StructureClass structureClass = Structures.DARK_TOWER.getStructureClass();
    ...
    public static class StructurePiece
    {
        ...
        public void generate(WorldTickEvent event)
        {
            if(origin != null)
            {
                structure = new DarkTower(event.world, origin, 0, 0, 0);
                generatePart = 1;
                origin = null;
            }
        }
        ...
        public void generatePart1(WorldTickEvent event)
        {
            ...
            {
            	DarkTowerComponents.generatePart1();
                DarkTowerComponents.generatePart2();
                this.generatePart = 2;
            }
        }
        ...
        public void generatePart2(WorldTickEvent event)
        {
            ...
            {
            	DarkTowerComponents.generatePart3();
                DarkTowerComponents.generatePart4();
                this.generatePart = 0;
            }
        }
