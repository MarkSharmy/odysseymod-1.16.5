...
public class PlayerPageControls
{
    ...
    static class PreviousButtonAction implements Button.IPressable
    {
		...
		{
			count--;
			MerchantGui.INSTANCE.playerPage = count;
			System.out.println(MerchantGui.INSTANCE.playerPage);
