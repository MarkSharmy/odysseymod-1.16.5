...
public class BakeryMerchant extends MerchantEntity {

	public BakeryMerchant(EntityType<? extends CreatureEntity> type, World worldIn) 
	{
		super(type, worldIn);
	}
	...
	public ActionResultType applyPlayerInteraction(PlayerEntity player, Vector3d vec, Hand hand)
	{
		if(hand == Hand.MAIN_HAND)
		{
			...
			MerchantGui.createInstance(this, MerchantType.BAKER, player, BakeryTrades.getMerchantItems());
			TradeManager.start();
		}
