...
public class InnKeeper extends MerchantEntity {

	public InnKeeper(EntityType<? extends CreatureEntity> type, World worldIn)
	{
		super(type, worldIn);
	}
	...
	public ActionResultType applyPlayerInteraction(PlayerEntity player, Vector3d vec, Hand hand)
	{
		if(hand == Hand.MAIN_HAND)
		{
			...
			MerchantGui.createInstance(this, MerchantType.INNKEEPER, player, TavernTrades.getMerchantItems());
			TradeManager.start();
		}
