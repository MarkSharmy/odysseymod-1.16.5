...
public class LeanOnCounterGoal extends Goal
{
   ...
   public LeanOnCounterGoal(MerchantEntity entityIn)
   {
	   this(entityIn, CounterEntity.class, 2.0f);
   }
   
   public LeanOnCounterGoal(MerchantEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance)
   {
      this(entityIn, watchTargetClass, maxDistance, 240);
   }

   public LeanOnCounterGoal(MerchantEntity entityIn, Class<? extends LivingEntity> watchTargetClass, float maxDistance, int chanceIn)
   {
   ...
   {
      ModelAnimations.startLeaningAnimation(entity);
   }

   public void resetTask()
   {
      this.closestEntity = null;
      ModelAnimations.endLeaningAnimation(entity);
   }
