...
public class RandomKickingGoal extends Goal
{
	private ModEntity entity;
	protected int executionChance;
	private boolean stopWhenIdle;
	
	public RandomKickingGoal(ModEntity entityIn)
	{
		this(entityIn, 240);
	}
	
	public RandomKickingGoal(ModEntity entityIn, int chance)
	{
		this(entityIn, chance, true);
	}
	
	public RandomKickingGoal(ModEntity entityIn, int chance, boolean stopWhenIdle)
	{
	...
	{
		ModelAnimations.startKickingAnimation(entity);
	}
	...
	{
		ModelAnimations.endKickingAnimation(entity);
	}
