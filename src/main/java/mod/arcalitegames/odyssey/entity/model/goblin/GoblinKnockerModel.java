...
public class GoblinKnockerModel<T extends GoblinKnocker> extends EntityModel<T>
{
	...
	public GoblinKnockerModel()
	{
		...
		LeftArm.setTextureOffset(32, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, 0.0F, false);

		LeftHand = new ModelRenderer(this);
		LeftHand.setRotationPoint(1.0F, 4.0F, 0.0F);
		LeftArm.addChild(LeftHand);
		setRotationAngle(LeftHand, -1.5708F, 0.0F, 0.0F);
		LeftHand.setTextureOffset(32, 48).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 8.0F, 4.0F, 0.0F, false);

		Shield = new ModelRenderer(this);
		Shield.setRotationPoint(1.0F, 4.0F, -6.0F);
		LeftArm.addChild(Shield);
		Shield.setTextureOffset(43, 2).addBox(-4.0F, -4.0F, -1.0F, 8.0F, 10.0F, 1.0F, 0.0F, false);
		Shield.setTextureOffset(39, 3).addBox(-5.0F, -3.0F, -1.0F, 1.0F, 8.0F, 1.0F, 0.0F, false);
		Shield.setTextureOffset(39, 3).addBox(4.0F, -3.0F, -1.0F, 1.0F, 8.0F, 1.0F, 0.0F, false);
		Shield.setTextureOffset(41, 0).addBox(-3.0F, 6.0F, -1.0F, 6.0F, 2.0F, 1.0F, 0.0F, false);
